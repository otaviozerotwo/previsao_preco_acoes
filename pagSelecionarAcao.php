        ...
        <form action="consultaBase.php" method="GET">
            <div class="row">
                <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-6 offset-md-3 offset-sm-3 offset-xs-3">
            ...
            <div class="row">
                <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-6 offset-md-3 offset-sm-3 offset-xs-3 botoes-modificada">
                        <button type="submit" id="btn-carregar-dados"
                            class="btn btn-primary w-100 py-2 my-4">CARREGAR DADOS</button>
                    </div>
                </div>
            </div>
        </form>
